...
<template>
  <div class="column flex-center bg-blue">
    <div class="col-12">
      {{ props.kérdés }}
      <q-btn class="q-ma-md" color="green" glossy :label="igenFelirat" no-caps @click="emit('btnPressed', true)" />
      <q-btn class="q-ma-md" color="red" glossy :label="nemFelirat" no-caps @click="emit('btnPressed', false)" />
    </div>
  </div>
</template>
